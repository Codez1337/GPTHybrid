...
class lic_keys
{
	...
	* @access private
	*/
	var $home_url_site = 'http://www.offerscript.net/order';
	...
	*/
	function lic_keys($license_key, $remote_auth, $key_location = 'license.php', $key_age = 1296000)
	{
		// Set the class vars
	...
	*/
	...
	{		
		...
		curl_setopt($ch, CURLOPT_USERAGENT, 'GPT Hybrid (www.gpthybrid.com)');
